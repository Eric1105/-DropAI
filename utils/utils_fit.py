...
def fit_one_epoch(model_train, model, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, cuda, ce_loss, dice_loss, focal_loss, cls_weights, num_classes, fp16, scaler, save_period, save_dir, local_rank=0):
    total_loss      = 0
    total_f_score   = 0
    ...
    for iteration, batch in enumerate(gen):
        ...
        if not fp16:
            ...
            if ce_loss:
                loss = CE_Loss(outputs, pngs, weight=weights)
